...
template<class MODULE> class TESTBENCH {
    public:
        ...
        WB_info tick(void) {
            ...
            WB_info ret;
            ret.wb_have_inst = dut->io_debug_wb_have_inst;
            ret.wb_pc = dut->io_debug_wb_pc;
            ret.wb_ena = dut->io_debug_wb_ena;
            ret.wb_reg = dut->io_debug_wb_reg;
            ret.wb_value = dut->io_debug_wb_value;
            return ret;
        }
};
#endif
